    ...
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2019, 11, 16, 1, 52, 10, 687, DateTimeKind.Local).AddTicks(5500), 1L });

            migrationBuilder.InsertData(
                table: "MembershipCards",
                columns: new[] { "Id", "CreatedAt", "MemberId" },
                values: new object[] { 2L, new DateTime(2019, 11, 16, 1, 52, 10, 698, DateTimeKind.Local).AddTicks(6240), 2L });
