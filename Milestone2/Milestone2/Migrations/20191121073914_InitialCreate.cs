    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2019, 11, 21, 13, 39, 13, 596, DateTimeKind.Local).AddTicks(6277), 1L });

            migrationBuilder.InsertData(
                table: "MembershipCards",
                columns: new[] { "Id", "CreatedAt", "MemberId" },
                values: new object[] { 2L, new DateTime(2019, 11, 21, 13, 39, 13, 597, DateTimeKind.Local).AddTicks(8637), 2L });
