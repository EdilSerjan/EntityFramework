    ...
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2019, 12, 21, 12, 18, 31, 401, DateTimeKind.Local).AddTicks(9810), 1L });

            migrationBuilder.InsertData(
                table: "MembershipCards",
                columns: new[] { "Id", "CreatedAt", "MemberId" },
                values: new object[] { 2L, new DateTime(2019, 12, 21, 12, 18, 31, 412, DateTimeKind.Local).AddTicks(8680), 2L });
